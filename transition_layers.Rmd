...
keep_layers	
Should layers be kept on screen after they have appeared or transition out when a new layer enters
from_blank	
...
First attempt
add two layers geom_point and geom_histogram
...
I still struggle to understand the layer_length and transition_length 
```{r first attempt}
 ggplot(mtcars ) + 
