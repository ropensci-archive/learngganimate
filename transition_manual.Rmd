...
In this example we will be using the `okcupiddata` `r emo::ji("package")` `r emo::ji("heart")` to visualize how feelings about pets change with star sign, sex and status. First let's begin with some data wrangling.   
