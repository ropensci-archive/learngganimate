...
* `r emo::ji("cat")` [Danielle Navarro](https://github.com/SaskiaFreytag) `r emo::ji("bird")` [\@djnavarro](https://twitter.com/djnavarro)
...
group of animation explorers in the wild, amazing jungle `r emo::ji("tree")` of [`gganimate` package](https://github.com/thomasp85/gganimate) `r emo::ji("package")`

We aim to create documentation and share our user experience for this amazing `r emo::ji("star")`, yet sparsly documented package `r emo::ji("package")`.
