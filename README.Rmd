...
group of animation explorers in the wild `r emo::ji("tiger")`, amazing jungle `r emo::ji("tree")` of [`gganimate` package](https://github.com/thomasp85/gganimate) `r emo::ji("package")`.
