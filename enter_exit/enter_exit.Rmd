...
This animation uses
  `geom_line()` and `geom_label()`
  with a 
  `transition_reveal()`
  and `enter_grow(fade = TRUE)` and  `exit_shrink(fade = TRUE)`.
...
```{r ozbabynames install, eval=FALSE}
...
* AAAAAh!! Last minutes hacks... Don't understand why *Mitchell* doesn't go away!!!
